...
class TweetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tweet" do
    assert_difference('Tweet.count') do
      post tweets_url, params: { tweet: { screen_name: @tweet.screen_name, text: @tweet.text } }
    end
  ...
  test "should update tweet" do
    patch tweet_url(@tweet), params: { tweet: { screen_name: @tweet.screen_name, text: @tweet.text } }
